...
export default function Video() {
    ...
    useEffect(() => {
        fetch(`https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&id=${videoId}&key=AIzaSyAhsjAeW2mq3P5hkFg5t5_e6ZhKoRIUoLs`)
            .then((res) => res.json())
            ...
            <div className='ml-[400px]'>
                ...
                <div className='text-[#AAAAAA] flex mt-[12px] border-b-2 border-[#303030] w-[800px] pb-[14px]'>
                    ...
                    <div className='flex gap-[15px] ml-[239px] '>
                        ...
                        <div className='text-white flex items-center gap-[4px]'>
                            <Image src="/dislike.svg" width={25} height={25} alt='dislike' />
                        </div>
                        ...
                        <div className='text-white flex items-center gap-[6px] text-[15px] font-medium'>
                            <Image src="/save.svg" width={25} height={25} alt='save' />
                            SAVE
                        </div>
                        <div className='text-white'>
                            <Image src="/threeDots.svg" width={25} height={25} alt='dits' />
                        </div>
                    </div>
                </div>
                {/* description area  */}
                ...
                <div className='mt-[40px] flex gap-[30px]'>
                    ...
                    <h4 className='text-white flex gap-[10px]'>
                        <Image src="/sort.svg" width={30} height={30} />
                        SORT BY
                    </h4>
                </div>
                <div className='mt-[20px] flex items-center'>
                    <Image src="/skylar.svg" width={55} height={55} />
                ...
                <div className='mt-[20px] flex w-[800px]'>
                    <Image src="/james.svg" width={55} height={55} />
                    <div className='flex flex-col ml-[20px] mt-[40px]'>
                        ...
                        <div className='text-white flex items-center text-sm '>
                            <Image src="/like.svg" width={24} height={24} className='mr-[5px]' />
                            5.9K
                            <Image src="/dislike.svg" width={24} height={24} className='ml-[15px]' />
                            <p className='text-[#AAAAAA] text-[12px] ml-[25px]'>REPLY</p>
                        </div>
                    </div>
                </div>
                <div className='mt-[10px] flex w-[800px]'>
                    <Image src="/alan.svg" width={55} height={55} />
                    <div className='flex flex-col ml-[20px] mt-[20px]'>
                        ...
                        <div className='text-white flex items-center text
